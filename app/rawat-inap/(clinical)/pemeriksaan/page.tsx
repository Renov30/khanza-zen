...
const TABLE_COLUMNS = [
  ...
  { key: 'nadi', label: 'Nadi(/mnt)', w: '70px' },
  { key: 'respirasi', label: 'Respirasi(/mnt)', w: '90px' },
  { key: 'tinggi', label: 'Tinggi(Cm)', w: '65px' },
  { key: 'berat', label: 'Berat(Kg)', w: '60px' },
  { key: 'spo2', label: 'SpO2(%)', w: '55px' },
  { key: 'gcs', label: 'GCS(E,V,M)', w: '70px' },
  { key: 'kesadaran', label: 'Kesadaran', w: '90px' },
  { key: 'keluhan', label: 'Subjek', w: '180px' },
  { key: 'pemeriksaan', label: 'Objek', w: '180px' },
  { key: 'alergi', label: 'Alergi', w: '130px' },
  { key: 'penilaian', label: 'Asesmen', w: '180px' },
  { key: 'rtl', label: 'Plan', w: '180px' },
  { key: 'instruksi', label: 'Instruksi', w: '150px' },
  { key: 'evaluasi', label: 'Evaluasi', w: '150px' },
  { key: 'nip', label: 'NIP', w: '80px' },
