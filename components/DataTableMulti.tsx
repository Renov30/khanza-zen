...
export default function DataTableMulti({
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden h-full">
      ...
      <div className="flex-1 overflow-auto bg-slate-50/50 relative h-full custom-scrollbar dark:bg-slate-900/50">
              ...
              return (
                <tr
                  ...
                  className={`border-b border-slate-100 cursor-pointer transition-all duration-200 dark:border-slate-700
                    ${isSelected ? "bg-brand-50 shadow-[inset_4px_0_0_0_var(--color-brand-500)] text-slate-700 dark:bg-slate-700 dark:text-slate-100" : "bg-white dark:bg-slate-800"} 
                    hover:bg-brand-50 hover:shadow-[inset_4px_0_0_0_var(--color-brand-500)] dark:hover:bg-slate-700`}
                >
                    <td className="py-2 px-3 text-center border-r border-slate-100 dark:border-slate-700">
                    <input
                      type="checkbox"
                      className="w-3.5 h-3.5 accent-brand-600 cursor-pointer"
                      checked={isSelected}
